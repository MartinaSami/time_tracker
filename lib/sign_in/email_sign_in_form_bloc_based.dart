...
import 'package:flutter_andreafirst/sign_in/email_sign_in_bloc.dart';
...
class EmailSignInFormBlocBased extends StatefulWidget {
  ...
  @override
  EmailSignInFormBlocBasedState createState() =>
      EmailSignInFormBlocBasedState();
}

class EmailSignInFormBlocBasedState extends State<EmailSignInFormBlocBased> {
  ...
  Future<void> _submit() async {
    try {
      ...
      showExceptionAlertDialog(
          context, title: 'Sign in Failed', exception: error);
    }
  }
